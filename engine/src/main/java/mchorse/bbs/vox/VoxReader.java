...
import mchorse.bbs.vox.data.VoxChunk;
...
public class VoxReader extends BinaryReader {
    ...
    public Matrix3f readRotation(int rotation) {
        ...
        matrix.setRow(0, v.set(0, 0, 0).setComponent(firstIndex, negativeFirst ? -1 : 1));
        matrix.setRow(1, v.set(0, 0, 0).setComponent(secondIndex, negativeSecond ? -1 : 1));
        matrix.setRow(2, v.set(0, 0, 0).setComponent(thirdIndex, negativeThird ? -1 : 1));
