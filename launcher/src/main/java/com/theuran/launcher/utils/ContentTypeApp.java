...
public class ContentTypeApp {
    public static final ContentType GAMEMODES = new ContentType("gameModes", IKey.EMPTY, TheLauncherData::getGameModes, dashboard -> dashboard.getPanel(UIGameModePanel.class));
}
